<%@ Page Language="C#" Title="Chiết khấu" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="thong-ke-chiet-khau.aspx.cs" Inherits="IM_PJ.thong_ke_chiet_khau" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <main id="main-wrap">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <h3 class="page-title left">Chiết khấu</h3>
                            ...
                            <table class="table table-checkable table-product">
                                <tbody>
                                    <tr>
                                        ...
                                        <th>Chiết khấu trung bình mỗi ngày</th>
                                    </tr>
