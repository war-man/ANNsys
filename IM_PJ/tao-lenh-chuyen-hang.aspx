<%@ Page Title="Tạo lệnh chuyển hàng" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="tao-lenh-chuyen-hang.aspx.cs" Inherits="IM_PJ.tao_lenh_chuyen_hang" %>
                ...
                <div class="col-md-12">
                    <div class="panel panelborderheading">
                        <div class="panel-heading clear">
                            <h3 class="page-title left not-margin-bot">Tạo lệnh chuyển hàng</h3>
                        </div>
                        <div class="panel-body">
                            ...
                            <div class="form-row">
                                ...
                                <select id="moveProStatus" class="form-control" style="width: 20%; display:inline-block">
                                ...
                                if (supplier != 0)
                                {
                                    if (supplierID == supplier) {
                                        if (check == false) {
                                            ...
                                            html += "   <td style=\"width:20%;\"><input type=\"text\" min=\"0\" max=\"" + item.QuantityInstock + "\" class=\"form-control in-quanlity\" style=\"width: 40%;margin: 0 auto;\" value=\"1\"  onkeyup=\"checkQuantiy($(this))\" onkeypress='return event.charCode >= 48 && event.charCode <= 57'/></td>";
