<%@ Page Title="Chi tiết nơi nhận nhà xe" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="chi-tiet-noi-den-nha-xe.aspx.cs" Inherits="IM_PJ.chi_tiet_noi_den_nha_xe" %>
                ...
                <div class="col-md-12">
                    <div class="panel panelborderheading">
                        <div class="panel-heading clear">
                            <h3 class="page-title left not-margin-bot">Thông tin nơi nhận</h3>
                        </div>
                        <div class="panel-body">
                            ...
                            <div class="form-row">
                                ...
                                <div class="row-right">
                                    <asp:TextBox ID="txtCompanyPhone" runat="server" CssClass="form-control capitalize" Enabled="false" TabIndex="2"></asp:TextBox>
                                </div>
                            </div>
                            <div class="form-row">
                                <div class="row-left">
                            ...
                            <div class="form-row">
                                <asp:Button ID="btnUpdate" runat="server" CssClass="btn primary-btn fw-btn not-fullwidth" Text="Cập nhật" OnClick="btnUpdate_Click" TabIndex="9" />
