    ...
    public partial class chi_tiet_san_pham : System.Web.UI.Page
    {
        ...
        public void LoadData()
        {
            ...
            else
            {
                ...
                ltrEdit1.Text += "<a href='javascript:;' onclick='getAllProductImage(`" + p.ProductSKU + "`);' class='btn primary-btn margin-right-15px'><i class='fa fa-cloud-download'></i> Tải tất cả hình ảnh</a>";
