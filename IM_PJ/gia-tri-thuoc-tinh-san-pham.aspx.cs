...
namespace IM_PJ
{
    public partial class gia_tri_thuoc_tinh_san_pham : System.Web.UI.Page
    {
        ...
        #region Paging
        public void pagingall(List<tbl_ProductVariableValue> acs)
        {
            int PageSize = 15;
            ...
            if (acs.Count > 0)
            {
                ...
                for (int i = FromRow; i < ToRow + 1; i++)
                {
                    var item = acs[i];
                    html.Append("<tr>");
                    html.Append("   <td>" + item.ProductvariableSKU + "</td>");
                    ...
                    html.Append("   <td>");
                    html.Append("       <a href=\"/thong-tin-gia-tri-thuoc-tinh?id=" + item.ID + "\" class=\"btn primary-btn h45-btn\">Chi tiết</a>");
                    html.Append("   </td>");
                    html.Append("</tr>");
                }
            }
