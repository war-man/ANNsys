<%@ Page Title="Thông báo App" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="danh-sach-thong-bao.aspx.cs" Inherits="IM_PJ.danh_sach_thong_bao" EnableSessionState="ReadOnly" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <main id="main-wrap">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <h3 class="page-title left">Thông báo App <span>(<asp:Literal ID="ltrNumberOfPost" runat="server" EnableViewState="false"></asp:Literal>)</span></h3>
        ...
        <script type="text/javascript">
            ...
            function ajaxDeletePost(id, callback)
            {
                ...
                $.ajax({
                    type: "POST",
                    url: "/danh-sach-thong-bao.aspx/deletePost",
                    data: "{id: " + id + "}",
                    contentType: "application/json; charset=utf-8",
                    dataType: "json",
                    async: false,
            ...
            function updateAtHome(obj)
            {
                ...
                $.ajax({
                    type: "POST",
                    url: "/danh-sach-thong-bao.aspx/updateAtHome",
