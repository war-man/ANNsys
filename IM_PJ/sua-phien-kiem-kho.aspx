<%@ Page Title="Sửa phiên kiểm kho" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="sua-phien-kiem-kho.aspx.cs" Inherits="IM_PJ.sua_phien_kiem_kho" EnableSessionState="ReadOnly" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <main id="main-wrap">
        <div class="container">
            <div class="form-row">
                <div class="col-xs-12 none-padding-left">
                    <h3 class="page-title left not-margin-bot">Sửa phiên kiểm kho</h3>
                </div>
            </div>
            <div class="form-row">
                <div class="col-sm-5 col-xs-8 none-padding-left">
                    <asp:TextBox runat="server" ID="txtTestName" CssClass="form-control" placeholder="Tên phiên kiểm kho" autocomplete="off" disabled="disabled" ReadOnly/>
                </div>
                <div class="col-sm-2 col-xs-4">
                    <asp:DropDownList ID="ddlStock" runat="server" CssClass="form-control" disabled="disabled" ReadOnly>
            ...
            <div class="form-row hidden">
                <div class="excute-in">
                    <a href="javascript:;" style="background-color: #f87703; float: right;" class="btn primary-btn link-btn" onclick="updateCheckWarehouse()">Cập nhật phiên kiểm kho</a>
                </div>
        ...
        <asp:HiddenField ID="hdfProductRemoval" runat="server" />
    ...
    <script type="text/javascript">
        ...
        function loadData() {
            let checkID = +$("#<%=hdfCheckID.ClientID%>").val() || 0;
            ...
            $.ajax({
                ...
                type: "POST",
                url: "/sua-phien-kiem-kho.aspx/getProductByCheckID",
                data: JSON.stringify({ checkID: checkID }),
                ...
                error: function (xmlhttprequest, textstatus, errorthrow) {
                    ...
                    return swal({
                        title: 'Thông báo',
                        text: 'Đã có lỗi trong quá trình lấy sản phẩm',
                        type: 'error'
                    });
                }
            });
        ...
        function searchProduct() {
            ...
            $.ajax({
                ...
                type: "POST",
                url: "/sua-phien-kiem-kho.aspx/getProduct",
                ...
                success: function (msg) {
                    ...
                    if (productNew.length > 0) {
                        productNew.forEach((item) => {
                            _productRemoval = _productRemoval.filter(id => id != item.ID);
                        })
                ...
                return swal({
                    ...
                    if (isConfirm) {
                        $tdChecked.each((index, element) => {
                            _productRemoval.push(element.dataset.id);
        ...
        function updateCheckWarehouse() {
            if ($(".product-result").length > 0) {
                HoldOn.open();

                $("#<%=hdfProductRemoval.ClientID%>").val(JSON.stringify(_productRemoval));
