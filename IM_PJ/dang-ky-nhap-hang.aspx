...
<head runat="server">
    ...
    <link rel="stylesheet" href="/App_Themes/Ann/css/style-sp.css?v=17052020" media="all">
...
<body>
    <form id="form12" runat="server" enctype="multipart/form-data">
        ...
        <div>
            ...
            <script src="/App_Themes/Ann/js/copy-product-info.js?v=17052020"></script>
            <script src="/App_Themes/Ann/js/sync-product-small.js?v=17052020"></script>
