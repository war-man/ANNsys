...
<head runat="server">
    ...
    <link rel="stylesheet" href="/App_Themes/Ann/css/style.css?v=10042020" media="all">
    <link rel="stylesheet" href="/App_Themes/Ann/css/style-P.css?v=10042020" media="all">
    <link href="/App_Themes/NewUI/js/select2/select2.css" rel="stylesheet" />
    <link rel="stylesheet" href="/App_Themes/Ann/css/style-sp.css?v=10042020" media="all">
...
<body>
    <form id="form12" runat="server" enctype="multipart/form-data">
        ...
        <div>
            ...
            <script src="/App_Themes/Ann/js/master.js?v=10042020"></script>
            <script src="/App_Themes/NewUI/js/sweet/sweet-alert.js?v=10042020" type="text/javascript"></script>
            <script src="/App_Themes/Ann/js/copy-product-info.js?v=10042020"></script>
            <script src="/App_Themes/Ann/js/sync-product-small.js?v=10042020"></script>
