...
namespace IM_PJ
{
    public partial class quan_ly_dai_ly : System.Web.UI.Page
    {
        ...
        {
            List<tbl_Agent> a = new List<tbl_Agent>();
        ...
        #region Paging
        public void pagingall(List<tbl_Agent> acs)
        {
            int PageSize = 15;
            ...
            if (acs.Count > 0)
            {
                ...
                if (ToRow >= TotalItems)
                    ToRow = TotalItems - 1;
                //html.Append("<tr>");
                //html.Append("   <td>Đại lý chính</td>");
                ////html.Append("   <td>ANN</td>");
                //html.Append("   <td>0918567409 – 0913268406 – 0936786404</td>");
                //html.Append("   <td>K4C Bửu Long, Phường 15, Quận 10, TP. HCM</td>");               
                //html.Append("   <td></td>");
                //html.Append("   <td></td>");
                //html.Append("   <td>");                
                ...
                for (int i = FromRow; i < ToRow + 1; i++)
                {
                    ...
                    //html.Append("   <td>" + item.AgentLeader + "</td>");
                    html.Append("   <td>" + item.AgentPhone + "</td>");
                    html.Append("   <td>" + item.AgentAddress + "</td>");
