<%@ Page Title="Chi tiết nhận hàng" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="chi-tiet-nhan-hang.aspx.cs" Inherits="IM_PJ.chi_tiet_nhan_hang" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <main id="main-wrap">
                ...
                <div class="col-md-12">
                    <div class="panel panelborderheading">
                        <div class="panel-heading clear">
                            <h3 class="page-title left not-margin-bot">Chi tiết nhận hàng</h3>
                        </div>
                        <div class="panel-body">
                            <div class="form-row">
                                <span style="width: 20%; float: left;">Đại lý chuyển: </span>
                                <asp:Literal ID="ltrAgentSend" runat="server"></asp:Literal>
                            </div>
                            <div class="form-row">
                                <span style="width: 20%; float: left;">Đại lý nhận: </span>
                                <asp:Literal ID="ltrAgentReceive" runat="server"></asp:Literal>
                            </div>
                            <div class="form-row">
                                <span style="width: 20%; float: left;">Ghi chú: </span>
                            ...
                            <div class="form-row">
                                <input type="text" id="txtSearch" class="form-control" placeholder="Nhập mã SKU"
                                ...
                                <asp:Literal ID="ltrSupplier" runat="server" Visible="false"></asp:Literal>
                                <a href="javascript:;" class="btn primary-btn fw-btn not-fullwidth" style="margin-right: 10px"
                                    onclick="searchProduct()">Tìm sản phẩm</a>
                            </div>
                            <div class="form-row">
                                <h3 class="no-margin float-left">Danh sách sản phẩm đến: <span class="result-numsearch"></span></h3>
        ...
        <asp:HiddenField ID="hdfListProductSend" runat="server" />
    ...
    <script type="text/javascript">
        ...
        function searchProduct() {
            ...
            var getSKUs = $("#<%=hdfListProductSend.ClientID%>").val();
            var listSKU = getSKUs.split('|');
            if (listSKU.length - 1 > 0) {
                for (var i = 0; i < listSKU.length - 1; i++) {
                    var sku = listSKU[i];
                    if (sku == textsearch) {
                        $(".product-result").each(function () {
                            var skuFind = $(this).attr("data-sku");
                            if (skuFind == textsearch) {
