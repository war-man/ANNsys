<%@ Page Title="Kiểm tra kệ để hàng" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="kiem-ke.aspx.cs" Inherits="IM_PJ.kiem_ke" EnableSessionState="ReadOnly" EnableEventValidation="false" %>
                    ...
                    <div class="col-md-12">
                        <div class="panel panelborderheading">
                            <div class="panel-heading clear">
                                <h3 class="page-title left not-margin-bot">Kiểm kê sản phẩm trên kệ</h3>
                            </div>
                            <div class="panel-body">
                                <div class="filter-above-wrap clear">
                                    <div class="filter-control">
                                        <div class="row">
                                            <h5 style="margin-left: 1%">Chọn kệ đang kiểm kê</h5>
                                        </div>
                                        <div class="row">
