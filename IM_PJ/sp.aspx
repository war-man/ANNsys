...
<body>
    <form id="form12" runat="server" enctype="multipart/form-data">
        ...
        <div>
            ...
            <script src="/App_Themes/Ann/js/services/common/product-service.js?v=30042020"></script>
            <script src="/App_Themes/Ann/js/sync-product-small.js?v=30042020"></script>
            <script src="/App_Themes/Ann/js/download-product-image.js?v=30042020"></script>
            <script src="/App_Themes/Ann/js/HoldOn.js?v=30042020"></script>
