...
<head runat="server">
    ...
    <link rel="stylesheet" href="/App_Themes/Ann/css/style-sp.css?v=28042020" media="all">
...
<body>
    <form id="form12" runat="server" enctype="multipart/form-data">
        ...
        <div>
            ...
            <script src="/App_Themes/Ann/js/services/common/product-service.js?v=28042020"></script>
            <script src="/App_Themes/Ann/js/sync-product-small.js?v=28042020"></script>
            <script src="/App_Themes/Ann/js/download-product-image.js?v=28042020"></script>
            <script src="/App_Themes/Ann/js/HoldOn.js?v=28042020"></script>
