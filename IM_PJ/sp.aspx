...
<head runat="server">
    ...
    <link href="/App_Themes/Ann/css/HoldOn.css?v=30032020" rel="stylesheet" type="text/css" />
    <link href="/App_Themes/NewUI/js/select2/select2.css" rel="stylesheet" />
    <link rel="stylesheet" href="/App_Themes/Ann/css/style-sp.css?v=30032020" media="all">
...
<body>
    <form id="form12" runat="server" enctype="multipart/form-data">
        ...
        <div>
            ...
            <script src="/App_Themes/Ann/js/copy-product-info.js?v=30032020"></script>
            <script src="/App_Themes/Ann/js/services/common/product-service.js?v=30032020"></script>
            <script src="/App_Themes/Ann/js/sync-product-small.js?v=30032020"></script>
            <script src="/App_Themes/Ann/js/download-product-image.js?v=30032020"></script>
            <script src="/App_Themes/Ann/js/HoldOn.js?v=30032020"></script>
