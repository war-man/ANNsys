...
<head runat="server">
    ...
    <link href="/App_Themes/Ann/css/HoldOn.css?v=09052020" rel="stylesheet" type="text/css" />
...
<body>
    <form id="form12" runat="server" enctype="multipart/form-data">
        ...
        <div>
            ...
            <script src="/App_Themes/Ann/js/sync-product-small.js?v=09052020"></script>
            <script src="/App_Themes/Ann/js/download-product-image.js?v=09052020"></script>
            <script src="/App_Themes/Ann/js/HoldOn.js?v=09052020"></script>
