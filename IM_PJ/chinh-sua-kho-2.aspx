<%@ Page Title="Chỉnh số lượng kho 2" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="chinh-sua-kho-2.aspx.cs" Inherits="IM_PJ.chinh_sua_kho_2" EnableSessionState="ReadOnly" %>
                ...
                <div class="col-md-12">
                    <div class="panel panelborderheading">
                        <div class="panel-heading clear">
                            <h3 class="page-title left not-margin-bot">Chỉnh số lượng kho 2</h3>
                        </div>
                        <div class="panel-body">
                            ...
                            <div class="form-row">
                                ...
                                <div class="excute-in">
                                    <a href="javascript:;" style="background-color: #f87703; float: right;" class="btn primary-btn link-btn" onclick="inProduct()">Chỉnh sửa số lượng kho</a>
