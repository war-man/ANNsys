...
namespace IM_PJ
{
    public partial class danh_sach_anh_san_pham : System.Web.UI.Page
    {
        ...
        #region Paging
        public void pagingall(List<tbl_ProductImage> acs)
        {
            int PageSize = 15;
            ...
            if (acs.Count > 0)
            {
                ...
                for (int i = FromRow; i < ToRow + 1; i++)
                {
                    var item = acs[i];
                    html.Append("<tr>");
                    html.Append("   <td style=\"width:20%\"><img src=\"" + Thumbnail.getURL(item.ProductImage, Thumbnail.Size.Small) + "\" alt=\"\" /></td>");
