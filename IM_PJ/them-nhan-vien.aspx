<%@ Page Title="Thêm nhân viên" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="them-nhan-vien.aspx.cs" Inherits="IM_PJ.them_nhan_vien" %>
                    ...
                    <div class="panel panelborderheading">
                        ...
                        <div class="panel-body">
                            ...
                            <div class="form-row">
                                <div class="row-left">
                                    Tên đăng nhập
                                    <asp:RequiredFieldValidator ID="rq" runat="server" ControlToValidate="txtUsername" ForeColor="Red" SetFocusOnError="true"
