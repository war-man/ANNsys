...
namespace IM_PJ
{
    public partial class danh_sach_chiet_khau : System.Web.UI.Page
    {
        ...
        //    Response.Redirect("/danh-sach-khach-hang?s=" + search + "&id=" + ddlDiscount.SelectedValue + "&by=" + ddlCreateBy.SelectedValue + "&p=" + ddlProvince.SelectedValue + "");
